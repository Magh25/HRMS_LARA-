            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4 align-self-xl-center">
                ...
                <div class="card-body align-items-center justify-content-between">
                  ...
                  <form action="<?php echo e(url('admin/notice')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohammed/WEB/laravel/blockgem/Laravel_HRM-master/resources/views/admin/notice/create.blade.php ENDPATH**/ ?>