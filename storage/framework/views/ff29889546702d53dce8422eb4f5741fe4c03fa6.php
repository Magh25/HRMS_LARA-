    ...
    <!-- Total User Card Example -->
            ...
            <div class="col-xl-12 col-md-10 mb-4">
              <div class="card ">
                ...
                <!-- --------------------------- -->
                <form action="<?php echo e(url('employee/attandence')); ?>" method="GET">
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohammed/WEB/laravel/blockgem/Laravel_HRM-master/resources/views/employee/attandence/index.blade.php ENDPATH**/ ?>