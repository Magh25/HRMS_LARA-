              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php ($i=1); ?>
                      <?php $__currentLoopData = $leave_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaveTypes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e($i++); ?></td>
                        <td><?php echo e($leaveTypes -> leave_typ); ?></td>
                        <th><?php echo e($leaveTypes -> num_leaves); ?></th>
                        <th><?php echo e($leaveTypes -> created_at); ?></th>
                        <td>

                          <button data-leave_types_id="<?php echo e($leaveTypes->id); ?>" data-leave_typ="<?php echo e($leaveTypes->leave_typ); ?>" data-num_leaves="<?php echo e($leaveTypes->num_leaves); ?>"
                          type="button" class="btn btn-warning" data-toggle="modal" data-target="#updateLeave"
                          id="#updateLeaveTypes">
                          <i class="fas fa-user-edit">Update</i></button>


                            <button type="submit" class="btn btn-danger" data-leave_types_id="<?php echo e($leaveTypes->id); ?>" data-toggle="modal" data-target="#deleteLeave"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
              <div class="modal-header">
                ...
                <form action="<?php echo e(url('admin/leave_types')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          <div class="modal-header">
            ...
            <form action="<?php echo e(url('admin/leave_types/update')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <form action="<?php echo e(url ('admin/leave_types/destroy')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohammed/WEB/laravel/blockgem/Laravel_HRM-master/resources/views/admin/leave/leave_types.blade.php ENDPATH**/ ?>