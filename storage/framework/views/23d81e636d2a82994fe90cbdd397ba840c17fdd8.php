                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <button data-salary_id="<?php echo e($salary->id); ?>" data-amount="<?php echo e($salary->amount); ?>" data-created_at="<?php echo e($salary-> created_at); ?>" data-target="#updateSalary" id="#updateSalaryAmount" type="button" class="btn btn-warning" data-toggle="modal"
                      ><i class="fas fa-user-edit">Update</i></button>
                    <button data-salary_id="<?php echo e($salary->id); ?>" data-target="#deleteSalary" id="#deleteSalaryAmount" type="button" class="btn btn-danger" data-toggle="modal"
...
<div class="modal fade" id="addSalary" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/salaries')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <form action="<?php echo e(url('admin/salaries/update')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <form action="<?php echo e(url('admin/salaries/destroy')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohammed/WEB/laravel/blockgem/Laravel_HRM-master/resources/views/admin/salary/index.blade.php ENDPATH**/ ?>