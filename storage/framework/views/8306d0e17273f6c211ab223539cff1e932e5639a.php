                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo e($departments->deg1); ?></td>
                        <td><?php echo e($departments->deg2); ?></td>
                        <td><?php echo e($departments->created_at); ?></td>

                        <td><button data-dept_id="<?php echo e($departments->id); ?>" data-name="<?php echo e($departments->name); ?>" data-deg1="<?php echo e($departments->deg1); ?>" data-deg2="<?php echo e($departments->deg2); ?>" type="button" class="btn btn-warning" data-toggle="modal" data-target="#updateDepartment"
                      id="#updateDepartmentName"><i class="fas fa-user-edit">Update</i></button>
                    <button data-dept_id="<?php echo e($departments->id); ?>" type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteDepartment"
...
<div class="modal fade" id="addDepartment" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
              <div class="modal-header">
                ...
                <form action="<?php echo e(url('admin/departments')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo e(url('admin/departments/update')); ?>"method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <form action="<?php echo e(url('admin/departments/destroy')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohammed/WEB/laravel/blockgem/Laravel_HRM-master/resources/views/admin/system/department/index.blade.php ENDPATH**/ ?>